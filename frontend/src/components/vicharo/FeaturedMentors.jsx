            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-6 flex items-center justify-between border-t border-black/10 pt-4">
                  ...
                  <span
                    data-testid={`mentor-view-${m.id}`}
                    className="inline-flex items-center gap-1 border border-navy bg-navy px-3 py-2 text-xs font-semibold uppercase tracking-widest text-paper transition-colors group-hover:bg-saffron group-hover:text-navy group-hover:border-saffron"
                  >
                    View profile
                  </span>
                </div>
